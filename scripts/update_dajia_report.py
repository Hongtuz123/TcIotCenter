    ...
    <table>
      ...
      <tbody>
        <tr style="background: rgba(239, 68, 68, 0.12);">
          <td><strong style="color: #ef4444;">04:00～08:00</strong></td>
          <td style="color: #f87171; font-weight: 600;">清晨逆溫壓制期</td>
          <td><strong>520 ppb</strong></td>
          <td><strong style="color: #ef4444; font-size: 1.05rem;">7,083 次</strong></td>
          <td><strong>16.7%</strong></td>
          <td><span style="background: #ef4444; color: white; padding: 3px 8px; border-radius: 4px; font-size: 0.8rem; font-weight: 700;">第一優先 (黃金窗口)</span></td>
        </tr>
        <tr style="background: rgba(249, 115, 22, 0.08);">
          <td><strong>00:00～04:00</strong></td>
          <td style="color: #fb923c; font-weight: 600;">深夜偷排高發期</td>
          <td><strong>465 ppb</strong></td>
          <td><strong style="color: #f97316; font-size: 1.05rem;">7,489 次</strong></td>
          <td><strong>14.2%</strong></td>
          <td><span style="background: #f97316; color: white; padding: 3px 8px; border-radius: 4px; font-size: 0.8rem; font-weight: 700;">高優先 (夜間跟監)</span></td>
        </tr>
        <tr>
          <td>20:00～24:00</td>
          <td>夜間排放蓄積期</td>
